...
import pandas as pd
import os
from utils.database import load_from_database, check_db_exists
...
def main():
    ...
    # Check if database exists and load data
    if check_db_exists(st.session_state.db_path):
        ...
        st.info("Welcome to Personal Finance Tracker! To get started, import your financial statements from the Import Data page.")
